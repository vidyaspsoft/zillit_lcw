...
export const BOX_SCHEDULE_HEADERS = {
  ...
  // Mirrors the production web app's `devicename` header — server expects it
  // for browser-origin requests (iOS native doesn't need it).
  devicename:
    '{"browser":{"name":"Chrome","version":"147.0.0.0"},"os":{"name":"macOS","version":"10.15.7","versionName":"Catalina"},"platform":{"type":"desktop","vendor":"Apple"},"engine":{"name":"Blink"}}',
