...
const ShareScheduleModal = ({ open, onClose, scheduleDays = [], scheduleTypes = [] }) => {
  ...
  const handleCopyAsText = () => {
    // Build plain text schedule summary
    const typeCounters = {};
    const allDays = [];
  ...
  return (
    <Modal open={open} onCancel={onClose} centered width={480}
      ...
      <div style={{ padding: '8px 0' }}>
        ...
        <div style={{
          padding: '16px', background: '#fafaf8', border: '1px solid #e0ddd8',
          ...
          {shareUrl ? (
            <div className="flex gap-2">
              ...
              <Button icon={copied ? <FiCheck size={13} /> : <FiCopy size={13} />} onClick={handleCopyLink}
                style={{ borderRadius: '6px', borderColor: copied ? '#27ae60' : '#d0ccc5', color: copied ? '#27ae60' : '#555' }}>
                {copied ? 'Copied' : 'Copy'}
              </Button>
            </div>
          ) : (
        ...
        <div style={{
          ...
          <Button icon={textCopied ? <FiCheck size={13} /> : <FiCopy size={13} />} onClick={handleCopyAsText}
            style={{ borderRadius: '6px', borderColor: textCopied ? '#27ae60' : '#d0ccc5', color: textCopied ? '#27ae60' : '#555' }}>
