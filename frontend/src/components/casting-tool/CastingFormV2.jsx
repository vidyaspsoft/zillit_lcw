...
const DEFAULT_SECTION_ORDER = [
  ...
  { id: 'character', label: 'Character Info', icon: '\uD83C\uDFAC' },
  { id: 'talent', label: 'Talent Info', icon: '\uD83D\uDC64' },
  { id: 'profile', label: 'Talent Profile', icon: '\uD83D\uDCCB' },
...
const STORAGE_KEY = 'zillit-casting-form-section-order';

const CastingFormV2 = ({ casting, onSubmit, onClose, activeTab, toolType = 'main' }) => {
  ...
  const renderSection = (sectionId, number) => {
    switch (sectionId) {
      case 'media':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Media & Links', 'Headshots, audition tapes, and reference links')}
      ...
      case 'character':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Character Info', 'Details about the character being cast')}
            ...
            {/* Character Breakdown (collapsible, shown when characterName is set) */}
            {characterName && (
              <div className="mt-4 border border-gray-100 rounded-lg overflow-hidden">
                <Button
                  type="link"
                  className="!px-4 !py-3 !text-blue-600 !font-semibold !w-full !text-left !flex !items-center !gap-2"
      ...
      case 'talent':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Talent Info', 'Information about the actor or performer')}
            <div className="grid grid-cols-2 gap-3">
              {/* Talent Name */}
              <div className="col-span-2">
                <label className="text-xs font-medium text-gray-600 mb-1 block">
      ...
      case 'profile':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Talent Profile', 'Physical characteristics and professional details')}
            <div className="grid grid-cols-2 gap-3">
              <div>
      ...
      case 'audition':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Audition', 'Audition details and rating')}
            <div className="grid grid-cols-2 gap-3">
              <div>
      ...
      case 'availability':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Availability', 'When is this talent free to shoot?')}
      ...
      case 'contact':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Contact Info', "Add agent, manager, or talent's direct contact")}
      ...
      case 'notes':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            {renderSectionHeader(number, 'Notes', 'Audition notes, director feedback, deal terms')}
            <Input.TextArea
              value={description}
